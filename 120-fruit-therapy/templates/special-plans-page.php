<?php
/**
 * Special Plans Menu Page Template
...
<div class="ftp-wrapper">
    ...
    <section class="ftp-menu-full ftp-section" id="ftp-plans-full">
        <div class="ftp-container">
            ...
            <nav class="ftp-menu-nav">
                <div class="ftp-menu-nav-list">
                    ...
                    <a href="#plan-<?php echo esc_attr($key); ?>" class="ftp-menu-nav-item">
            ...
            <!-- Menu Categories -->
            <?php foreach ($menu_items as $key => $category) : ?>
            <div class="ftp-menu-category" id="plan-<?php echo esc_attr($key); ?>">
